...
const createMetricsHostsAnomaliesQuery = ({
  ...
  const sourceFields = ['job_id', 'record_score', 'typical', 'actual', 'partition_field_value', 'timestamp', 'bucket_span', 'by_field_value', 'host.name', 'influencers.influencer_field_name', 'influencers.influencer_field_values'];
  const {
    querySortDirection,
    queryCursor
