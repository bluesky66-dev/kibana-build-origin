...
exports.stateActionMachine = stateActionMachine;
 ...
 * completed step
 */
async function stateActionMachine(initialState, // It would be nice to use generics to enforce that model should accept all
...
next, model) {
  ...
  while (nextAction != null) {
    ...
    const newState = model(state, actionResponse); // Get ready for the next step
