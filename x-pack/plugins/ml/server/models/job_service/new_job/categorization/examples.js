...
function categorizationExamplesProvider({
  ...
  async function categorizationExamples(indexPatternTitle, query, size, categorizationFieldName, timeField, start, end, analyzer, runtimeMappings) {
  ...
  async function validateCategoryExamples(indexPatternTitle, query, size, categorizationFieldName, timeField, start, end, analyzer, runtimeMappings) {
    const resp = await categorizationExamples(indexPatternTitle, query, _categorization_job.CATEGORY_EXAMPLES_SAMPLE_SIZE, categorizationFieldName, timeField, start, end, analyzer, runtimeMappings);
    const {
      examples
    } = resp;
