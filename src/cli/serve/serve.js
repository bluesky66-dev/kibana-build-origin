...
const DEV_MODE_PATH = (0, _path.resolve)(__dirname, '../../dev/cli_dev_mode');
...
function _default(program) {
  ...
  if (!_utils2.IS_KIBANA_DISTRIBUTABLE) {
  ...
  command.action(async function (opts) {
    if (opts.dev && opts.devConfig !== false) {
      try {
        const kbnDevConfig = (0, _utils3.fromRoot)('config/kibana.dev.yml');
