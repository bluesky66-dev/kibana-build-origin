...
function jobAuditMessagesProvider({
  ...
  async function getAuditMessagesSummary(jobIds) {
    ...
    if (body.hits.total.value > 0 && body.aggregations && body.aggregations.levelsPerJob && body.aggregations.levelsPerJob.buckets && body.aggregations.levelsPerJob.buckets.length) {
