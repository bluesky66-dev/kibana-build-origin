...
function jobServiceRoutes({
  ...
  router.post({
    ...
    try {
      ...
      const resp = await newJobLineChart(indexPatternTitle, timeField, start, end, intervalMs, query, aggFieldNamePairs, splitFieldName, splitFieldValue, runtimeMappings);
      return response.ok({
        body: resp
      });
    } catch (e) {
  ...
  router.post({
    ...
    try {
      ...
      const resp = await newJobPopulationChart(indexPatternTitle, timeField, start, end, intervalMs, query, aggFieldNamePairs, splitFieldName, runtimeMappings);
      return response.ok({
        body: resp
      });
    } catch (e) {
  ...
  router.post({
    ...
    try {
      ...
      const resp = await validateCategoryExamples(indexPatternTitle, query, size, field, timeField, start, end, analyzer, runtimeMappings);
      return response.ok({
        body: resp
      });
    } catch (e) {
