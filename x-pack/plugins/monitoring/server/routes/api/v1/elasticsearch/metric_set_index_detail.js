...
const metricSet = {
  advanced: [{
    keys: ['index_mem_overall_1', 'index_mem_stored_fields', 'index_mem_doc_values', 'index_mem_norms'],
    name: 'index_1'
  }, {
    keys: ['index_mem_overall_2', 'index_mem_terms', 'index_mem_points'],
    name: 'index_2'
  }, {
    keys: ['index_mem_overall_3', 'index_mem_fixed_bit_set', 'index_mem_term_vectors', 'index_mem_versions'],
    name: 'index_3'
  }, {
