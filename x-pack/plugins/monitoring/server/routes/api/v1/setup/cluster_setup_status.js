  ...
  server.route({
    ...
    config: {
      validate: {
        params: _configSchema.schema.object({
          clusterUuid: _configSchema.schema.maybe(_configSchema.schema.string())
        }),
    ...
    handler: async req => {
      ...
      try {
        ...
        status = await (0, _collection.getCollectionStatus)(req, indexPatterns, req.params.clusterUuid, null, req.query.skipLiveData);
      } catch (err) {
