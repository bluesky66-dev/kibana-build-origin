...
const metricSet = [{
  keys: ['beat_pipeline_events_total_rate', 'beat_output_events_total', 'beat_output_events_ack_rate', 'beat_pipeline_events_emitted_rate'],
  name: 'beat_event_rates'
}, {
  keys: ['beat_pipeline_events_failed_rate', 'beat_pipeline_events_dropped_rate', 'beat_output_events_dropped_rate', 'beat_pipeline_events_retry_rate'],
