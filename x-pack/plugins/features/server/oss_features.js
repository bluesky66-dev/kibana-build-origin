  ...
  return [{
    ...
    privileges: {
      all: {
        ...
        savedObject: {
          all: ['dashboard', 'query'],
          read: ['index-pattern', 'search', 'visualization', 'timelion-sheet', 'canvas-workpad', 'lens', 'map', 'tag']
        },
      ...
      read: {
        ...
        savedObject: {
          all: [],
          read: ['index-pattern', 'search', 'visualization', 'timelion-sheet', 'canvas-workpad', 'lens', 'map', 'dashboard', 'query', 'tag']
        },
        ui: ['show']
      }
    },
